...
parser.add_argument('--scale_channels',type=int,default=8,help='scale channels')
...
try:
    for epoch in range(1, args.epochs + 1):
        ...
        val_loss = evaluate(Data, Data.valid[0], Data.valid[1], model,
                                           args.batch_size)
        print(
        ...
        if val_loss < best_val:
            ...
            best_val = val_loss
        if epoch % 5 == 0:
            test_acc = evaluate(Data, Data.test[0], Data.test[1], model,
                                                 args.batch_size)
            print("test rse {:5.4f}".format(test_acc), flush=True)
